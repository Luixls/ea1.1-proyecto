class SeccionController {
  ...
  static editar(req, res) {
      ...
      if (index !== -1) {
          SeccionController.secciones[index] = { ...SeccionController.secciones[index], nombre, materiaId };
          res.json({ mensaje: 'Sección editada con éxito', seccion: SeccionController.secciones[index] });
      } else {
