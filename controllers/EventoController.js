...
class EventoController {
    ...
    static eventosPorSemana(req, res) {
        ...
        const eventosFiltrados = EventoController.eventos.filter(evento => {
            ...
            return evento.materiaId == materiaId && fechaEvento >= fechaInicioDate && fechaEvento < fechaFinDate;
        });
        ...
        res.render('eventosPorSemana', { eventos: eventosFiltrados, nombreMateria });
    }
    ...
    static eventosProximosPorProfesor(req, res) {
        ...
        const eventosPorProfesor = ProfesorController.profesores.map(profesor => {
